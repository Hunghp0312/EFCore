...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Seed Data
        var dep1 = Guid.Parse("5b671e57-cc34-4c2a-85f4-052d4986fc3f"); var dep2 = Guid.Parse("34f1fc66-f258-4470-8c79-16f86f030ec9"); var dep3 = Guid.Parse("f5bd00a2-2f2a-4a60-9e20-c7c8cb78583e"); var dep4 = Guid.Parse("78a83ad9-d7c1-4cc7-9134-8813fa8ad3e9");
        ...
        var sal1 = Guid.Parse("0b138abc-2972-44d2-bb4e-3297c1c7dc70"); var sal2 = Guid.Parse("3826c308-9644-4190-8d0c-1a2f3074ec2e"); var sal3 = Guid.Parse("bfcfe80f-259c-4f20-b153-f8c7c3e89ed6"); var sal4 = Guid.Parse("f7d3ff43-4639-4812-b508-5fcdd648e7c0");
        ...
        modelBuilder.Entity<Employee>().HasData(
            new Employee { Id = emp1, Name = "Alice", DepartmentId = dep1, JoinedDate = new DateTime(2022, 5, 1), SalaryId = sal1 },
            new Employee { Id = emp2, Name = "Bob", DepartmentId = dep2, JoinedDate = new DateTime(2023, 1, 15), SalaryId = sal2 },
            new Employee { Id = emp3, Name = "Charlie", DepartmentId = dep1, JoinedDate = new DateTime(2021, 8, 20), SalaryId = sal1 },
            new Employee { Id = emp4, Name = "Diana", DepartmentId = dep3, JoinedDate = new DateTime(2022, 11, 5), SalaryId = sal4 },
            new Employee { Id = emp5, Name = "Charlie", DepartmentId = dep4, JoinedDate = new DateTime(2021, 8, 20), SalaryId = sal3 },
            new Employee { Id = emp6, Name = "Diana", DepartmentId = dep3, JoinedDate = new DateTime(2022, 11, 5), SalaryId = sal3 }
        );
        ...
        modelBuilder.Entity<Salary>().HasData(
            new Salary { Id = sal1, EmployeeId = emp1, SalaryAmount = 70000 },
            new Salary { Id = sal2, EmployeeId = emp2, SalaryAmount = 55000 },
            new Salary { Id = sal3, EmployeeId = emp3, SalaryAmount = 75000 },
            new Salary { Id = sal4, EmployeeId = emp4, SalaryAmount = 60000 }
        );
    }
}
