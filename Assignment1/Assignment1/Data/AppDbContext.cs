...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>().HasData(
            new Employee { Id = emp1, Name = "Alice", DepartmentId = dep1, JoinedDate = new DateTime(2022, 5, 1) },
            new Employee { Id = emp2, Name = "Bob", DepartmentId = dep2, JoinedDate = new DateTime(2023, 1, 15) },
            ...
            new Employee { Id = emp5, Name = "Charlie", DepartmentId = dep4, JoinedDate = new DateTime(2021, 8, 20) },
        ...
        modelBuilder.Entity<Salaries>().HasData(
            new Salaries { Id = sal1, EmployeeId = emp1, Salary = 70000 },
            new Salaries { Id = sal2, EmployeeId = emp2, Salary = 55000 },
            new Salaries { Id = sal3, EmployeeId = emp3, Salary = 75000 },
            new Salaries { Id = sal4, EmployeeId = emp4, Salary = 60000 }
        );
    }
}
